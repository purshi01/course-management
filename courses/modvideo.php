<?php
SESSION_START();
if((isset($_GET['cid']) && !empty($_GET['cid'])) || isset($_POST['cid']))
{
include '../con.inc.php';
$data=new database();
$data->connect();
...
if(empty($_GET['cid']))
{
 ...
 ?>
<form  action="modvideo.php" method="post" enctype="multipart/form-data">
...
<div class="container">
  ...
  echo "<h2> <a class='vid' href='videos.php'>Uploaded Videos</a><a href='../logout.php' style='float:right;''>Logout&emsp;&emsp;&emsp;</a></h2>";
...
<?php
                                                              ...
                                                              echo "</script>";
                                                                        ...
                                                                        if (file_exists("../teacher/videos/uploaded/".$name))
                                                                        {
                                                                          ...
                                                                          echo "</script>";
                                                                                    ...
                                                                                    move_uploaded_file($temp,"../teacher/videos/uploaded/".$name);
                                                                                    $url="http://localhost/course/teacher/videos/uploaded/$name";
                                                                                     ...
                                                                                     if(mysqli_query($data->con,$query))
                                                                                     {
                                                                                         ...
                                                                                         echo "<script language='javascript' type='text/javascript'>";
                                                                                         echo "alert('Video Uploaded Successfully');";
                                                                                         echo "</script>";
                                                        ...
                                                        echo "</script>";
                                                                ...
                                                                if (file_exists("../teacher/notes/uploaded/".$name))
                                                                {
                                                                  ...
                                                                  echo "</script>";
                                                                          ...
                                                                          move_uploaded_file($temp,"../teacher/notes/uploaded/".$name);
  ...
  echo "<center><h1>First upload a course name and course type BUDDY!!!!!!</center></h1>";
}
 ?>
