...
while ($row = mysqli_fetch_assoc($result))
{
    $id = $row['vid'];
    $name = $row['vname'];
    echo "<center><h2 class='city'><a href='watch.php?id=$id' style='color:black' >".$name."&nbsp&nbsp&nbsp</a><a href='VandNdelete.php?vid=$id'><span class='glyphicon glyphicon-trash'></span></a></h2></center>";
